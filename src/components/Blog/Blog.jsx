...
const Blog = ({blog, handleBookmarks, handleMarkAsRead}) => {
    const {id, title, cover_img, profile, reading_time, posted_date, author, hashtags} = blog;
    return (
        <div className=" mb-20">
           ...
           <button onClick={() => handleMarkAsRead(id, reading_time)} className="mt-3 text-purple-700 underline text-lg">Mark as Read</button>
        </div>
    );
};
